...
const BUILD = /* umich-lib */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: false, hasRenderFn: true, hostListener: true, hostListenerTarget: true, hostListenerTargetBody: false, hostListenerTargetDocument: true, hostListenerTargetParent: false, hostListenerTargetWindow: true, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: false, propNumber: false, propString: true, reflect: true, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: true, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: false, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: false };
...
const chatCss = "/*!@:host*/.sc-m-chat-h {\n  --chat-width: calc(var(--space-medium) * 20);\n  font-size: 16px;\n}\n\n/*!@.m-chat*/.m-chat.sc-m-chat {\n  position: fixed;\n  right: 4vw;\n  bottom: 0;\n  border-radius: 2px 2px 0 0;\n  border-top: solid 2px var(--color-maize-400);\n  box-shadow: var(--z-space-medium);\n  width: calc(var(--space-medium) * 14);\n  transition: width 0.25s;\n  max-width: calc(\n    100% - 8vw\n  ); \n  background: white;\n}\n\n/*!@.m-chat.m-chat--open*/.m-chat.m-chat--open.sc-m-chat {\n  width: var(--chat-width);\n}\n\n/*!@.m-chat__button*/.m-chat__button.sc-m-chat {\n  \n  border: none;\n  background: none;\n  outline: 0;\n  font-size: var(--font-base-size);\n  color: var(--color-neutral-400);\n  text-align: left;\n\n  \n  height: 39px; \n  width: 100%;\n  padding: 0 var(--space-medium);\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  border-radius: 2px 2px 0 0;\n  margin-bottom: 3px;\n}\n\n/*!@.m-chat__svg*/.m-chat__svg.sc-m-chat {\n  width: 32px;\n  height: 32px;\n  flex-shrink: 0;\n}\n\n/*!@.m-chat__icons*/.m-chat__icons.sc-m-chat {\n  line-height: 0;\n}\n\n/*!@.m-chat__button:focus*/.m-chat__button.sc-m-chat:focus {\n  outline: none;\n  box-shadow: 0 0 0 2px var(--color-maize-400),\n    0 0 0 3px var(--color-neutral-400);\n}\n\n/*!@.m-chat__iframe*/.m-chat__iframe.sc-m-chat {\n  width: 100%;\n  height: 100%;\n  border: none;\n}\n\n@media only screen and (min-width: 600px) {\n  /*!@.m-chat__iframe*/.m-chat__iframe.sc-m-chat {\n    width: var(--chat-width);\n  }\n}\n\n/*!@.m-chat__label*/.m-chat__label.sc-m-chat {\n  font-family: var(--font-base-family);\n  display: inline-block;\n  width: 100%;\n  padding: 0 var(--space-small);\n}\n\n/*!@.m-chat__button:hover .m-chat__label*/.m-chat__button.sc-m-chat:hover .m-chat__label.sc-m-chat {\n  text-decoration: underline;\n}\n\n/*!@.m-chat__window*/.m-chat__window.sc-m-chat {\n  background: white;\n  max-height: 90vh;\n  height: 0;\n  opacity: 0;\n  overflow: hidden;\n  transition: height 0.25s, opacity 0.25s;\n}\n\n/*!@.m-chat--open .m-chat__window*/.m-chat--open.sc-m-chat .m-chat__window.sc-m-chat {\n  opacity: 1;\n  height: calc(var(--space-medium) * 24);\n}\n\n/*!@.m-chat__offline*/.m-chat__offline.sc-m-chat {\n  line-height: 1.5;\n  font-family: var(--font-base-family);\n  padding: 0 var(--space-medium);\n\n  strong {\n    font-weight: 700;\n  }\n\n  a,\n  a:hover {\n    color: var(--color-teal-400);\n  }\n}\n\n/*!@.m-chat__offline-msg*/.m-chat__offline-msg.sc-m-chat {\n  border-radius: 4px;\n  background: var(--color-blue-100);\n  padding: var(--space-medium);\n}";
...
class Chat {
  ...
  render() {
    return (hAsync("div", { class: `m-chat${this.open ? " m-chat--open" : ''}` }, hAsync("button", { class: "m-chat__button", "aria-expanded": String(this.open), onClick: () => this.toggle() }, hAsync(ChatIcon, null), hAsync("span", { class: "m-chat__label" }, "Ask a Librarian"), hAsync("div", { "aria-hidden": "true", class: "m-chat__icons" }, !this.open ? (hAsync("svg", { width: "24px", height: "24px", viewBox: "0 0 24 24", class: "m-chat__open-icon" }, hAsync("path", { d: "M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z" }))) : (hAsync("svg", { width: "24px", height: "24px", viewBox: "0 0 24 24", class: "m-chat__close-icon" }, hAsync("path", { d: "M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z" }))))), hAsync("div", { class: "m-chat__window" }, this.online ? (hAsync("iframe", { class: "m-chat__iframe", title: "Ask a Librarian", src: "https://libraryh3lp.com/chat/umlibraryaskalibrarian@chat.libraryh3lp.com?skin=27279" })) : (hAsync("div", { class: "m-chat__offline" }, hAsync("p", { class: "m-chat__offline-msg" }, "We're ", hAsync("strong", null, "offline"), " right now, but you can", " ", hAsync("a", { href: "https://www.lib.umich.edu/ask-librarian" }, "view our hours and more ways to get in touch"), "."))))));
  }
...
function ChatIcon() {
  return (hAsync("svg", { height: "24", viewBox: "0 0 24 24", width: "24", class: "m-chat__svg" }, hAsync("path", { d: "m15.65 15.92v1.88a1.44 1.44 0 0 1 -.43 1 1.37 1.37 0 0 1 -1 .44h-10.3l-2.92 2.96v-13.2a1.39 1.39 0 0 1 .42-1 1.36 1.36 0 0 1 1-.43h5.93v6.9a1.4 1.4 0 0 0 .43 1 1.33 1.33 0 0 0 1 .44z", fill: "#ffcc06" }), hAsync("path", { d: "m21.53 4.24a1.45 1.45 0 0 1 1.47 1.45v13.2l-2.95-2.89h-10.28a1.37 1.37 0 0 1 -1-.44 1.47 1.47 0 0 1 -.42-1v-8.87a1.43 1.43 0 0 1 .42-1 1.39 1.39 0 0 1 1-.42z", fill: "#10284b" })));
}
...
const universalHeaderCss = "/*!@.m-uh*/.m-uh.sc-m-universal-header {\n  background: var(--color-blue-100);\n  font-family: var(--font-base-family);\n  line-height: var(--line-height-default);\n  font-size: 16px;\n\n  & * {\n    box-sizing: border-box;\n    -webkit-font-smoothing: antialiased; \n    -moz-osx-font-smoothing: grayscale; \n  }\n\n  & *:focus {\n    outline: 0;\n    box-shadow: 0 0 0 2px var(--color-maize-400),\n      0 0 0 3px var(--color-neutral-400);\n    border-radius: 2px !important;\n  }\n}\n\n/*!@.m-uh__content*/.m-uh__content.sc-m-universal-header {\n  display: flex;\n  justify-content: space-between;\n  max-width: 1280px;\n  margin: 0 auto;\n  padding: 0 var(--space-medium);\n\n  @media screen and (min-width: 721px) {\n    padding: 0 var(--space-xx-large);\n  }\n}\n\n/*!@.m-uh__button-container*/.m-uh__button-container.sc-m-universal-header {\n  display: inline-block;\n  position: relative;\n}\n\n/*!@.m-uh__button*/.m-uh__button.sc-m-universal-header {\n  \n  border: none;\n  background: none;\n  font-size: var(--font-base-size);\n  color: var(--color-neutral-400);\n  text-align: left;\n  line-height: var(--line-height-default);\n\n  \n  display: flex;\n  align-items: center;\n  cursor: pointer;\n}\n\n/*!@.m-uh__button,\n.m-uh__link*/.m-uh__button.sc-m-universal-header, .m-uh__link.sc-m-universal-header {\n  margin: 0;\n  text-transform: uppercase;\n  padding: var(--space-x-small);\n  margin: 0 calc(var(--space-x-small) * -1);\n  color: var(--color-neutral-300);\n  letter-spacing: 1.25px;\n  text-transform: uppercase;\n  font-size: 14px;\n  font-weight: var(--bold);\n  font-family: var(--font-base-family);\n\n  &:hover {\n    .m-uh__button-label {\n      text-decoration: underline;\n      text-decoration-thickness: 1px;\n    }\n  }\n}\n\n/*!@.m-uh__button-label*/.m-uh__button-label.sc-m-universal-header {\n  padding-right: var(--space-xx-small);\n}\n\n/*!@.m-uh__link*/.m-uh__link.sc-m-universal-header {\n  text-decoration: none;\n  margin-right: var(--space-x-large);\n\n  &:hover {\n    text-decoration: underline;\n    text-decoration-thickness: 1px;\n  }\n\n  @media screen and (min-width: 721px) {\n    display: block;\n  }\n}\n\n/*!@.m-uh__link-text*/.m-uh__link-text.sc-m-universal-header {\n  display: block;\n  @media screen and (max-width: 620px) {\n    display: none;\n  }\n}\n\n/*!@.m-uh__link-text--small*/.m-uh__link-text--small.sc-m-universal-header {\n  display: none;\n  @media screen and (max-width: 620px) {\n    display: block;\n  }\n}\n\n/*!@.m-uh__icons*/.m-uh__icons.sc-m-universal-header {\n  line-height: 0;\n}\n\n/*!@.m-uh__dropdown*/.m-uh__dropdown.sc-m-universal-header {\n  position: absolute;\n  right: calc(-1 * var(--space-medium));\n  width: 280px;\n  box-shadow: var(--z-space-medium);\n  max-width: calc(100vw - (var(--space-xx-large) * 2));\n  background: white;\n  border-radius: 2px;\n  z-index: 2;\n\n  @media screen and (min-width: 721px) {\n    display: grid;\n    grid-template: \"heading heading\" \"primary secondary\" / 1fr 280px;\n    padding: var(--space-medium);\n    width: 862px;\n    right: 0;\n  }\n}\n\n/*!@.m-uh__heading*/.m-uh__heading.sc-m-universal-header {\n  grid-area: heading;\n  margin-top: 0;\n  font-size: 28px;\n  font-weight: 700;\n  margin-bottom: 0;\n  padding: var(--space-small) var(--space-medium);\n\n  @media screen and (max-width: 720px) {\n    display: none;\n  }\n}\n\n/*!@.m-uh__list-primary,\n.m-uh__list-secondary*/.m-uh__list-primary.sc-m-universal-header, .m-uh__list-secondary.sc-m-universal-header {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  margin-bottom: var(--space-medium);\n\n  @media screen and (max-width: 720px) {\n    margin: 0;\n    li:not(:last-of-type) {\n      border-bottom: solid 1px var(--color-neutral-100);\n    }\n  }\n}\n\n/*!@.m-uh__list-primary*/.m-uh__list-primary.sc-m-universal-header {\n  grid-area: primary;\n  @media screen and (min-width: 721px) {\n    border-right: solid 1px var(--color-neutral-100);\n    margin-right: var(--space-medium);\n    padding-right: var(--space-medium);\n  }\n}\n\n/*!@.m-uh__list-secondary*/.m-uh__list-secondary.sc-m-universal-header {\n  grid-area: secondary;\n}\n\n@media screen and (max-width: 720px) {\n  /*!@.m-uh__list-primary*/.m-uh__list-primary.sc-m-universal-header {\n    border-bottom: solid 1px var(--color-neutral-100);\n  }\n}\n\n/*!@.m-uh__item-link*/.m-uh__item-link.sc-m-universal-header {\n  display: block;\n  color: var(--color-neutral-400);\n  font-weight: var(--semibold);\n  text-decoration: none;\n  padding: var(--space-x-small) var(--space-medium);\n  border-radius: 2px;\n\n  @media screen and (max-width: 720px) {\n    padding: var(--space-small) var(--space-medium);\n  }\n\n  &:hover {\n    @media screen and (max-width: 720px) {\n      border-radius: 0;\n      background: var(--color-blue-100);\n    }\n  }\n\n  &:hover,\n  &:focus {\n    .m-uh__item-title {\n      text-decoration: underline;\n      text-decoration-color: var(--color-teal-400);\n      text-decoration-thickness: 2px;\n    }\n  }\n}\n\n/*!@.m-uh__item-title*/.m-uh__item-title.sc-m-universal-header {\n  display: block;\n}\n\n/*!@.m-uh__item-desc*/.m-uh__item-desc.sc-m-universal-header {\n  display: none;\n\n  @media screen and (min-width: 721px) {\n    display: block;\n    font-weight: 400;\n    color: var(--color-neutral-300);\n  }\n}\n\n/*!@.m-uh__dropdown-error*/.m-uh__dropdown-error.sc-m-universal-header {\n  padding: 0 var(--space-medium);\n\n  strong {\n    font-weight: var(--bold);\n  }\n\n  a {\n    color: var(--color-teal-400);\n  }\n}";
...
const websiteFooterCss = "/*!@:host*/.sc-m-website-footer-h {\n  font-family: var(--font-base-family);\n  line-height: var(--line-height-default);\n  font-size: 16px;\n\n  * {\n    box-sizing: border-box;\n    -webkit-font-smoothing: antialiased; \n    -moz-osx-font-smoothing: grayscale; \n  }\n\n  *:focus {\n    outline: 0;\n    box-shadow: 0 0 0 2px var(--color-maize-400),\n      0 0 0 3px var(--color-neutral-400);\n    border-radius: 2px !important;\n  }\n\n  p {\n    margin: 0;\n  }\n}\n\n/*!@.website-footer*/.website-footer.sc-m-website-footer {\n  background: var(--color-blue-400);\n\n  & ul {\n    list-style: none;\n    margin: 0;\n    padding: 0;\n\n    a {\n      display: inline-block;\n      padding: var(--space-x-small) 0;\n\n      &:hover {\n        text-decoration-thickness: 2px;\n      }\n    }\n  }\n\n  & a {\n    color: white;\n  }\n}\n\n/*!@.website-footer__content*/.website-footer__content.sc-m-website-footer {\n  color: var(--color-blue-100);\n  padding: var(--space-xxx-large) 0;\n\n  & h2 {\n    color: var(--color-blue-200);\n    font-size: 0.875rem;\n    font-weight: 800;\n    letter-spacing: 1.25px;\n    text-transform: uppercase;\n\n    margin-bottom: var(--space-medium);\n  }\n\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(280px, 1fr));\n  gap: var(--space-medium);\n}\n\n/*!@.website-footer__disclaimer*/.website-footer__disclaimer.sc-m-website-footer {\n  background: var(--color-blue-500);\n  color: var(--color-blue-200);\n  padding: var(--space-medium) 0;\n\n  & a {\n    color: var(--color-blue-200);\n  }\n\n  @media screen and (min-width: 820px) {\n    & p {\n      display: \"inline-block\";\n    }\n\n    & p + p {\n      margin-left: var(--space-x-large);\n    }\n  }\n}";
...
class WebsiteFooter {
  ...
  render() {
    ...
    return (hAsync("footer", { class: "website-footer" }, hAsync("div", { class: "viewport-container" }, hAsync("div", { class: "website-footer__content" }, hAsync("section", null, hAsync("h2", null, "University of Michigan Library"), hAsync("p", null, "913 S. University Avenue", hAsync("br", null), "Ann Arbor, MI 48109")), this.navigation && this.navigation.map(section => {
      return (hAsync("section", null, hAsync("h2", null, section.title), hAsync("ul", null, section.items.map(item => (hAsync("li", null, hAsync("a", { href: item.href }, item.text)))))));
    }))), hAsync("div", { class: "website-footer__disclaimer" }, hAsync("div", { class: "viewport-container" }, hAsync("p", null, "\u00A9 ", this.getYear(), ", Regents of the University of Michigan")))));
  }
  static get style() { return websiteFooterCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "m-website-footer",
    "$members$": {
      "navigation": [520]
    },
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": [["navigation", "navigation"]]
  }; }
}

const websiteHeaderCss = "/*!@:host*/.sc-m-website-header-h {\n  font-family: var(--font-base-family);\n  line-height: var(--line-height-default);\n  font-size: 16px;\n  background: white;\n\n  * {\n    box-sizing: border-box;\n    -webkit-font-smoothing: antialiased; \n    -moz-osx-font-smoothing: grayscale; \n  }\n}\n\n/*!@.website-header*/.website-header.sc-m-website-header {\n  background: white;\n}\n\n/*!@.website-header__container*/.website-header__container.sc-m-website-header {\n  max-width: 1280px;\n  margin: 0 auto;\n  padding: var(--space-medium);\n\n  @media screen and (min-width: 721px) {\n    padding: var(--space-medium) var(--space-xx-large);\n  }\n}\n\n/*!@.website-header__inner-container*/.website-header__inner-container.sc-m-website-header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n\n/*!@.website-header__website-home-link*/.website-header__website-home-link.sc-m-website-header {\n  display: inline-flex;\n  align-items: center;\n  color: var(--color-neutral-300);\n  text-decoration: none;\n  line-height: 0; \n\n  @media screen and (max-width: 600px) {\n    flex-direction: column;\n    align-items: baseline;\n\n    svg {\n      margin-bottom: var(--space-x-small);\n    }\n  }\n\n  .website-header__website-name {\n    line-height: 1.1;\n  }\n\n  &:hover .website-header__website-name {\n    text-decoration: underline;\n  }\n}\n\n/*!@.website-header__website-name*/.website-header__website-name.sc-m-website-header {\n  display: block;\n  font-size: var(--text-large);\n\n  @media screen and (min-width: 600px) {\n    &::before {\n      display: inline-block;\n      content: \"/\";\n      margin: 0 var(--space-medium);\n    }\n  }\n}";
...
class WebsiteHeader {
  ...
  render() {
    return (hAsync("header", { class: "website-header" }, hAsync("div", { class: "website-header__container" }, hAsync("div", { class: "website-header__inner-container" }, hAsync("a", { href: this.to, class: "website-header__website-home-link" }, hAsync("m-logo", null), this.name && (hAsync("span", { class: "website-header__website-name" }, this.name))), hAsync("slot", null)))));
  }
